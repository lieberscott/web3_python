...
# to deploy a contract, you need the bytcode and abi
...
w3 = Web3(Web3.HTTPProvider("https://rinkeby.infura.io/v3/b37e697840cf43aea41361153469b183"))
chain_id = 4
...
# Call -> simulate making the call and getting a return value (do not make a state change to blockchain)
...
store_tx_receipt = w3.eth.wait_for_transaction_receipt(send_store_tx_hash)
